# HRnet - by Wealth Health (projet de ma formation OpenClassrooms "DA - JavaScript React")
...
Then, run the command `npm start`. Wait for the message : "Compiled successfully! You can now view my-app in the browser."
